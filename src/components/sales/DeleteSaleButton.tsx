...
const variantClasses: Record<NonNullable<DeleteSaleButtonProps['variant']>, string> = {
  default:
...
export default function DeleteSaleButton({ saleId, variant = 'ghost' }: DeleteSaleButtonProps) {
  const router = useRouter();
  const t = useTranslations('sales.delete');
