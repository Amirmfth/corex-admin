...
export default function NewPurchaseError({
  error,
  reset,
}: {
  ...
  const message = getFriendlyMessage(
    error,
    'We could not load the purchase form. Please try again.',
  );

  return (
    <div className="rounded-3xl border border-rose-200 bg-rose-50 p-6 text-rose-700">
      <h2 className="text-lg font-semibold">Something went wrong while loading purchases.</h2>
