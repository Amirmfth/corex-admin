...
export default function PurchaseDetailError({
  ...
  const message = getFriendlyMessage(error, 'We could not load this purchase. Please try again.');

  return (
    <div className="rounded-3xl border border-rose-200 bg-rose-50 p-6 text-rose-700">
      <h2 className="text-lg font-semibold">Something went wrong while loading the purchase.</h2>
